                  ...
                  <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                    ...
                    <li className="text-black">
                      <div className="flex">
                        <button
                          onClick={() => signOut()}
                          className="font-poppins font-semibold bg-blue-medium hover:bg-white hover:text-blue-pale border-2 hover:border-blue-medium py-1 px-3 rounded-xl text-white mr-2"
                        >
                          Sign-Out
                        </button>
                      </div>
